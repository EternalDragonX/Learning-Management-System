  ...
  <div class="theL-template-div">
    <a-form class="theL-search-form">
      <a-tabs default-active-key="1">
        ...
        <a-tab-pane key="3" tab="Generate Reports">
          <a-row class="synopsisRow">
            <a-col :span="8">
              <a-select
                label-in-value
                ...
                @change="handleChange"
              >
                <a-select-option value="1"> Report Type </a-select-option>
              </a-select>
            </a-col>
            ...
            <a-col :span="8">
              <a-select
                ...
                @change="handleChange"
              >
                <a-select-option value="1"> Within Department </a-select-option>
              </a-select>
            </a-col>
            ...
            <a-col :span="8">
              <a-select
                ...
                @change="handleChange"
              >
                <a-select-option value="1"> Courses </a-select-option>
              </a-select>
            </a-col>
          </a-row>
